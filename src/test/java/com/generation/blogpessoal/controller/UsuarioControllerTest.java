...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT) // Cria porta aleatória para evitar conflito com a 8080
@TestInstance(TestInstance.Lifecycle.PER_CLASS) // Indica que usaremos Before e AfterAll
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(
				new Usuario(null, "Carlos", "carlos@email.com", "12345678", "-"));
	...
	@Test
	@DisplayName("Não deve permitir duplicação du Usuário")
	public void naoDeveDuplicarUsuario() {

		usuarioService
				.cadastrarUsuario(new Usuario(null, "Maria da Silva", "maria_silva@email.com.br", "12345678", "-"));

		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(
				new Usuario(null, "Maria da Silva", "maria_silva@email.com.br", "12345678", "-"));
